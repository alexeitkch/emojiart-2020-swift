...
struct EmojiArtDocumentView: View {
    //@ObservedObject - property wrapper causing a View to redraw when  published change is deteced
            ...
            GeometryReader { geometry in
                ...
                .navigationBarItems(trailing: Button(action: {
                    if let url = UIPasteboard.general.url, url != self.document.backgroundURL {
                        ...
                        self.explainBackroundPaste = true
                    }
                }, label: {
                    Image(systemName: "doc.on.clipboard").imageScale(.large)
                        .alert(isPresented: self.$explainBackroundPaste) {
                            return Alert(
    ...
    @State private var explainBackroundPaste = false
